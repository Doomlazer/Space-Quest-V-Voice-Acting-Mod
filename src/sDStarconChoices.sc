		...
		(switch (= state newState)
			...
			(4
				...
				(if ((ScriptID 201 12) whichSelect?)
					...
					(switch ((ScriptID 201 12) whichSelect?)
						(1
							(gTestMessager say: 4 0 2 0 self 202)
						)
						(2
							(gTestMessager say: 4 0 3 0 self 202)
						)
						(3
							(gTestMessager say: 4 0 4 0 self 202)
						)
						(else  (= cycles 1))
					)
				else
		...
		(switch (= state newState)
			...
			(4
				...
				(if ((ScriptID 201 13) whichSelect?)
					...
					(switch ((ScriptID 201 13) whichSelect?)
						(1
							(gTestMessager say: 12 0 9 0 self 202)
						)
						(2
							(= local0 1)
							(gTestMessager say: 12 0 10 1 3 self 202)
						)
						(3
							(gTestMessager say: 12 0 11 0 self 202)
						)
						(else  (= cycles 1))
					)
				else
		...
		(switch (= state newState)
			...
			(4
				...
				(if ((ScriptID 201 12) whichSelect?)
					...
					(switch ((ScriptID 201 12) whichSelect?)
						(1
							(gTestMessager say: 26 0 37 0 self 202)
						)
						(2
						...
						(3
							...
							(gTestMessager say: 26 0 38 0 self 202)
						)
						(else  (= cycles 1))
					)
				else
				...
				(if ((ScriptID 201 12) whichSelect?)
					...
					(switch ((ScriptID 201 12) whichSelect?)
						(1
							...
							(gTestMessager say: 26 0 48 0 self 202)
						)
						(2
							(gTestMessager say: 26 0 49 0 self 202)
						)
						(3
							(gTestMessager say: 26 0 50 0 self 202)
						)
						(else  (= cycles 1))
					)
				else
...
(instance sDTree6Choice2 of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				(gTestMessager say: 26 0 40 1 2 self 202)
			)
			(1 (proc201_6 self))
			(2
				(gTestMessager say: 26 0 40 3 4 self 202)
			)
			(3
		...
		(switch (= state newState)
			...
			(4
				...
				(if ((ScriptID 201 13) whichSelect?)
					...
					(switch ((ScriptID 201 13) whichSelect?)
						(1
							(gTestMessager say: 12 0 33 0 self 202)
						)
						(2
							(gTestMessager say: 12 0 34 0 self 202)
						)
						(3
							(if (< global127 3)
								(gTestMessager say: 12 0 35 0 self 202)
							else
								(gTestMessager say: 25 0 22 0 self 202)
							)
						)
						(else  (= cycles 1))
					)
		...
		(switch (= state newState)
			...
			(4
				...
				(if ((ScriptID 201 13) whichSelect?)
					...
					(switch ((ScriptID 201 13) whichSelect?)
						(1
							(gTestMessager say: 12 0 28 0 self 202)
						)
						(2
							(gTestMessager say: 12 0 29 0 self 202)
						)
						(3
							(if (< global127 3)
								(gTestMessager say: 12 0 30 0 self 202)
							else
								(gTestMessager say: 25 0 22 0 self 202)
							)
						)
			...
			(4
				...
				(if ((ScriptID 201 13) whichSelect?)
					...
					(switch ((ScriptID 201 13) whichSelect?)
						(1
							(if (proc0_1 30)
								(gTestMessager say: 4 0 3 2 self)
							else
								(gTestMessager say: 12 0 43 0 self 202)
							)
						)
						(2
							(gTestMessager
						...
						(3
							(cond 
								((< global127 3) (gTestMessager say: 25 0 21 1 self 202))
								((and (not (proc0_1 30)) (== global127 3)) (gTestMessager say: 25 0 22 1 self 202))
								((and (proc0_1 30) (not (proc0_1 93))) (gTestMessager say: 25 0 26 1 self 202))
								((and (== global142 1) (not (proc0_1 94))) (gTestMessager say: 25 0 24 0 self 202))
								((and (>= global142 1) (not (proc0_1 75))) (gTestMessager say: 25 0 25 0 self 202))
								(else
									(gTestMessager
										say: 12 0 44 (+ (eureka destination?) 1) self 202
									)
		...
		(switch (= state newState)
			...
			(4
				...
				(if ((ScriptID 201 13) whichSelect?)
					...
					(switch ((ScriptID 201 13) whichSelect?)
						(1
							(gTestMessager say: 12 0 45 0 self 202)
						)
						(2
							(gTestMessager say: 12 0 46 0 self 202)
						)
						(3
							(if (< global127 3)
								(gTestMessager say: 12 0 60 0 self 202)
							else
								(gTestMessager say: 25 0 22 0 self 202)
							)
						)
		...
		(switch (= state newState)
			...
			(4
				...
				(if ((ScriptID 201 12) whichSelect?)
					...
					(switch ((ScriptID 201 12) whichSelect?)
						(1
							(gTestMessager say: 26 0 56 0 self 202)
						)
						(2
							(gTestMessager say: 26 0 57 0 self 202)
						)
						(3
							(gTestMessager say: 26 0 58 0 self 202)
						)
						(else  (= cycles 1))
					)
				else
			...
			(4
				...
				(if ((ScriptID 201 13) whichSelect?)
					...
					(switch ((ScriptID 201 13) whichSelect?)
						...
						(2
							(gTestMessager say: 12 0 53 0 self 202)
						)
						(3
							(gTestMessager say: 12 0 54 0 self 202)
						)
						(else  (= cycles 1))
					)
				else
...
(instance sFTree9Choice1 of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				(gTestMessager say: 12 0 52 1 5 self 202)
			)
			(1
				(proc201_7 self)
				(proc201_27 1)
			...
			(2
				(gTestMessager say: 12 0 52 6 self 202)
			)
			(3
			...
			(4
				(gTestMessager say: 12 0 52 7 8 self 202)
			)
			(5 (self dispose:))
		)
	)
...
(instance sFTree9Choice2 of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				(gTestMessager say: 12 0 53 1 8 self 202)
			)
			(1
			...
			(3
				(gTestMessager say: 12 0 53 9 10 self 202)
			)
			(4 (self dispose:))
		)
	)
		...
		(switch (= state newState)
			...
			(4
				...
				(if ((ScriptID 201 12) whichSelect?)
					...
					(switch ((ScriptID 201 12) whichSelect?)
						(1
							(gTestMessager say: 26 0 75 0 self 202)
						)
						(2
							(gTestMessager say: 26 0 76 0 self 202)
						)
						(3
							(gTestMessager say: 26 0 77 0 self 202)
						)
						(else  (= cycles 1))
					)
				else
		...
		(switch (= state newState)
			...
			(4
				...
				(if ((ScriptID 201 13) whichSelect?)
					...
					(switch ((ScriptID 201 13) whichSelect?)
						(1
							(gTestMessager say: 12 0 80 0 self 202)
						)
						(2
							(gTestMessager say: 12 0 81 0 self 202)
						)
						(3
							(gTestMessager say: 12 0 82 0 self 202)
						)
						(else  (= cycles 1))
					)
				else
		...
		(switch (= state newState)
			...
			(4
				...
				(if ((ScriptID 201 13) whichSelect?)
					...
					(switch ((ScriptID 201 13) whichSelect?)
						(1
							(gTestMessager say: 12 0 65 0 self 202)
						)
						(2
							(gTestMessager say: 12 0 66 0 self 202)
						)
						(else  (= cycles 1))
					)
				else
		...
		(switch (= state newState)
			...
			(4
				...
				(if ((ScriptID 201 13) whichSelect?)
					...
					(switch ((ScriptID 201 13) whichSelect?)
						(1
							(gTestMessager say: 12 0 84 0 self 202)
						)
						(2
							(gTestMessager say: 12 0 85 0 self 202)
						)
						(3
							(gTestMessager say: 12 0 87 0 self 202)
						)
						(else  (= cycles 1))
					)
				else
		...
		(switch (= state newState)
			...
			(4
				...
				(if ((ScriptID 201 12) whichSelect?)
					...
					(switch ((ScriptID 201 12) whichSelect?)
						(1
							(gTestMessager say: 26 0 71 0 self 202)
						)
						(2
							(gTestMessager say: 26 0 72 0 self 202)
						)
						(else  (= cycles 1))
					)
				else
...
(instance sDrooleComments of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				(gTestMessager say: 12 0 10 4 self 202)
			)
			(2
				(gEgo setLoop: 1 setCel: 0 posn: 178 95)
				(= cycles 2)
			...
			(3
				(gTestMessager say: 12 0 10 5 self 202)
			)
			(4
				(self setScript: (ScriptID 201 8) self)
			)
