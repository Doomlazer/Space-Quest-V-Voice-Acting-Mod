		...
		(switch (= state newState)
			...
			(4
				(if (& global169 $0008)
					...
					(gTestMessager say: 2 0 0 1 3 self 246)
				)
			)
			(5
				(aft show:)
			...
			(6
				(gTestMessager say: 2 0 0 4 10 self 246)
			)
			(7
				(aft hide:)
				(midSection hide:)
			...
			(8
				...
				(gSQ5 handsOn:)
				(exitSign init:)
				(gSq5IconBar disable: 0 3 2 4 5 6)
			)
			(9
				(gSQ5 handsOff:)
				(gSq5Music2 number: 106 loop: 1 play:)
				(gOldCast delete: gEgo)
...
(class Section of View
	...
	(method (doit)
		(if local2
			(cond 
				((self onMe: gPEventX (- gPEventY 10))
					(if
	...
	(method (handleEvent pEvent)
		(cond 
			...
			(
			(and (& (pEvent type?) evVERB) (self onMe: pEvent)) (pEvent claimed: 1) (self doVerb: (pEvent message?)))
		)
