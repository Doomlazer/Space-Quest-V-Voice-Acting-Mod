...
(instance rm1035 of Rm
	...
	(method (init)
		...
		(switch gGModNum
			(1020
				(if
				(or (== global133 1) (== global133 4) (== global133 6))
					(localproc_0052)
				else
					(localproc_0081)
				)
	...
	(method (doit)
		...
		(cond 
			((and (!= global144 global143) (== local10 0)) (theMusic3 number: 128 setLoop: -1 play:) (= local10 1))
			((and (== global144 global143) (== local10 1)) (theMusic3 stop:) (= local10 0))
		)
		(if
			(and
				(> (gEgo y?) 166)
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				(gSQ5 handsOff:)
				(gEgo
					setMotion: PolyPath [local0 (* register 2)] [local4 (* register 2)] self
				)
			)
			(1
				(gEgo
...
(instance sSquishRog of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				(if (< (liftBtm nsBottom?) (gEgo y?)) (-- state))
				(= cycles 1)
			)
			(2
