...
(instance deathRoom of Rm
	...
	(method (init)
		...
		(switch [local286 global119]
			(0
				(global2 setScript: sRogBeatUp)
			)
			(1
				(global2 setScript: sRogPuked)
			)
			(2
				(global2 setScript: sRogBurned)
			)
			(3
				(global2 setScript: sHeadExplodes)
			)
			(4
				(global2 setScript: sAccordion)
			)
			(5
				(global2 setScript: sFlattened)
			)
			(6 (global2 setScript: sFly))
			(7
				(global2 setScript: sGeneric)
			)
			(8
				(global2 setScript: sPixelOut)
			)
		)
	)
