			...
			(cond 
				(
					...
					(cond 
						...
						((proc999_5 temp0 27 67 99) (pEvent claimed: 1) (localproc_006c 11))
						((proc999_5 temp0 69 101) (pEvent claimed: 1) (localproc_006c 10))
	...
	(method (changeState newState &tmp [temp0 20])
		(switch (= state newState)
			(0
				(gSQ5 handsOn:)
				(if (== gModNum 460)
					(gSq5IconBar disable: 0 1 3 5 4 7)
				else
					(gSq5IconBar disable: 0 1 3 5 4 6)
				)
				(= register -1)
				(= cycles 1)
			)
			...
			(2
				...
				(if (!= gModNum 460) (gSq5IconBar enable: 0 1 3 5 4 6))
