...
(instance rm420 of Rm
	...
	(method (init)
		...
		(switch gGModNum
			(410
				...
				(global2 setScript: sRogEnter)
			)
			(440
				(gEgo init: view: 454 setLoop: 2 cel: 0)
				(global2 setScript: sRogSaved)
			)
			(450
			...
			(else 
				(global2 setScript: sPukoidAttack)
			)
		)
		(super init:)
	)
	...
	(method (doit)
		...
		(if
		(and (proc0_5 gEgo 32) (not (global2 script?)))
			(proc0_2 101)
			(global2 newRoom: 410)
		)
	)
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				...
				(if (proc0_1 77) (pukoidFeet init:) (flies init:))
				(switch gGModNum
					(410
						(if (not (proc0_1 90))
...
(instance sGotoComputer of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1 (gEgo loop: 2) (= cycles 2))
			(2 (global2 newRoom: 460))
		)
	)
)
...
(instance sPlastic of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				(if
				(< (gSQ5 detailLevel:) (plastic2 detailLevel:))
					(-- state)
				)
				(= seconds (Random 1 3))
			)
...
(instance paper of Actor
	...
	(method (doVerb theVerb)
		(switch theVerb
			(4
				(if (proc0_1 98) (global2 setScript: sGetPaper))
			)
			(else 
...
(instance theComputer of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(4
				(if (not (proc0_1 77))
					(global2 setScript: sComputer)
				else
					(global2 setScript: sGotoComputer)
				)
			)
			(3
				(if (not (proc0_1 77))
