...
(instance rm500 of Rm
	...
	(method (init)
		...
		(gOldWH addToFront: (ScriptID 501 30))
		(gOldWH addToFront: (ScriptID 501 31))
		(gOldWH addToFront: (ScriptID 501 3))
		(gOldWH addToFront: (ScriptID 501 33))
		(if (not (proc0_1 54))
		...
		(if (and (not (proc0_1 54)) (proc0_1 48))
			(bartender stopUpd:)
			(ex1 stopUpd:)
			(ex2 stopUpd:)
			(ex3 stopUpd:)
		...
		(switch gGModNum
			(510
				(if (and (proc0_1 54) (not (proc0_1 49)))
					(gSQ5 handsOff:)
					(global2 setScript: sEscape self)
				else
					(gSQ5 handsOff:)
					(global2 setScript: sFromDetention self)
				)
			)
			(520
				(gSQ5 handsOff:)
				(switch global124
					(9
						(proc0_3 62)
						(global2 setScript: sFromTableWQuirk)
						(flo setScript: sDrinking)
					)
					(8
						(proc0_2 62)
						(global2 setScript: sFromTableWSalesman)
						(flo setScript: sDrinking)
					)
					(7
						(proc0_2 62)
						(global2 setScript: sSalesmanToTable)
						(flo setScript: sDrinking)
					)
					(11
						(proc0_2 62)
			...
			(else 
				...
				(switch global124
					(0
						(proc0_2 52)
						(proc0_2 53)
						(proc958_0 128 500 20 0 515)
						(global2 setScript: sCrewFromEureka)
					)
					(1
						(global2 setScript: sRogerFromEureka)
					)
					(2
						(global2 setScript: sRogerFromEureka)
					)
					(10
						(global2 setScript: sCliffyFight)
					)
				)
			)
		)
	...
	(method (dispose)
		(gOldWH delete: (ScriptID 501 30))
		(gOldWH delete: (ScriptID 501 3))
		(gOldWH delete: (ScriptID 501 31))
		(gOldWH delete: (ScriptID 501 33))
		(gOldWH delete: self)
		(DisposeScript 501)
		(super dispose: &rest)
	)
	...
	(method (doVerb theVerb)
		(if (proc0_1 62)
			(switch theVerb
				(3
					...
					(global2 setScript: sGetUpFromTable)
					(return 1)
				)
				(else 
		...
		(if (proc0_1 70)
			(switch theVerb
				(3
					(= theGPEventX gPEventX)
					(= theGPEventY gPEventY)
					(global2 setScript: sFromUpstairs)
					(return 1)
				)
				(else 
					(super doVerb: theVerb &rest)
		...
		(return
			(switch theVerb
				(1
					(if (not (proc0_1 48))
						(gTestMessager say: 20 1 0 0)
					else
						(gTestMessager say: 20 1 1 0)
					)
				)
			)
		)
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				...
				(gSQ5 handsOff:)
				(if (and (proc0_1 48) (proc0_1 81))
					(global2 overlay: 78)
				)
				(if (and (proc0_1 52) (not (proc0_1 54)))
					((ScriptID 501 22) addToPic:)
					((ScriptID 501 25) startUpd:)
					(if (and (proc0_1 48) (not (proc0_1 81)))
					...
					(drool init:)
					(flo init:)
					(if (proc0_1 51) (flo setScript: sDrinking))
				)
				(if (proc0_1 50) (cliffy init:) (Cliffysfriend init:))
				(if (< global125 3)
					(salesman init:)
					(quirk init:)
				...
				(if (== global124 11) (proc0_2 62))
				(if (and (proc0_1 54) (not (proc0_1 69)))
...
(instance sEscape of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(3
				(gTestMessager say: 25 0 0 0 self)
			)
			(4
...
(instance sCliffyFight of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1 (= seconds 1))
			(2
				(gTestMessager say: 14 0 0 0 self)
			)
			(3
...
(instance gotoTeleporterFTable of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(8
				(if (proc0_1 48) (= global124 2) else (= global124 1))
				(gSq5Music1 fade:)
				(theMusic3 fade:)
				(global2 newRoom: 240)
			)
...
(instance genTalker of Narrator
	...
	(method (init)
		...
		(switch global122
			(49
				(gSq5Win tailX: 255 tailY: 130 xOffset: -90 isBottom: 1)
			)
			(9
				(gSq5Win tailX: 190 tailY: 75 xOffset: -70 isBottom: 1)
			)
		)
		(super init: &rest)
	)
