...
(instance sWD40Attacks of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(3 (= cycles 1))
			(4
				(gTestMessager say: 1 0 0 1 self 208)
			)
			(5
			...
			(6
				(gTestMessager say: 1 0 0 2 4 self 208)
			)
			(7
			...
			(11
				(gTestMessager say: 1 0 0 5 self 208)
			)
			(12
				(self setScript: (ScriptID 201 8) self)
			)
			...
			(21 (proc201_6 self))
			(22
				(gTestMessager say: 1 0 0 6 self 208)
			)
			(23
			...
			(25
				...
				(gTestMessager say: 1 0 1 0 self 208)
			)
			(26
			...
			(27 (proc201_7 self))
			(28
				(gTestMessager say: 2 0 0 1 self 208)
			)
			(29
				(self setScript: (ScriptID 201 8) self)
			)
			(30 (proc201_6 self))
			(31
				(gTestMessager say: 2 0 0 2 self 208)
			)
			(32
				(self setScript: (ScriptID 201 4) self)
			)
...
(instance sRemoveEggTimer of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(3
				(gTestMessager say: 3 0 0 1 self 208)
			)
			(4
				(self setScript: (ScriptID 209 1) self)
			)
