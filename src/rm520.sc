...
(instance rm520 of Rm
	...
	(method (init &tmp temp0)
		...
		(theFlo init:)
		(theDroole init:)
		(gOldWH addToFront: theExit)
		(global2 setRegions: 505)
		(switch global125
			(0
				(gSQ5 handsOff:)
				(proc958_0 128 524 522)
				(global2 setScript: sWaitress self)
			)
			(1
				(gSQ5 handsOff:)
				(proc958_0 128 524 521)
				(global2 setScript: sSalesman self)
			)
			(2
				(gSQ5 handsOff:)
				(proc958_0 128 524 523)
				(global2 setScript: sQuirk self)
			)
			(3
				(gSQ5 handsOn:)
				(proc958_0 128 524)
				(global2 setScript: sCrew self)
			)
			(else 
				(gSQ5 handsOn:)
				(proc958_0 128 524)
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				...
				(if (proc0_1 48) (drink setScript: sMonkeys))
				(= cycles 1)
			)
			(1 (self dispose:))
		)
...
(instance sWaitress of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(2
				(gTestMessager say: 0 0 0 0 self)
			)
			(3
...
(instance rogHead of View
	...
	(method (init)
		(switch global125
			...
			(2 (self cel: 1))
			(3
				(if (== local3 1) (self cel: 3) else (self cel: 1))
			)
		)
		(super init: &rest)
	)
...
(instance drink of Prop
	...
	(method (doVerb theVerb)
		(switch theVerb
			(34
				(= local3 1)
				(global2 setScript: sMonkeysInDrink)
			)
			(else 
		...
		(switch theVerb
			(2
				(switch local4
					(0
						(= local4 1)
						(gTestMessager say: 4 2 0 0)
					)
					(else 
						(gTestMessager say: 4 2 1 0)
					)
				)
			)
			(else 
		...
		(switch theVerb
			(2
				(switch local5
					(0
						(= local5 1)
						(gTestMessager say: 2 2 0 0)
					)
					(else 
						(gTestMessager say: 2 2 1 0)
					)
				)
			)
			(else 
