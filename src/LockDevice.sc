		...
		(return
			(switch theVerb
				(4
					...
					(cond 
						((== local2 deviceNum) (global2 setScript: openScript 0 deviceNum) (++ local2))
						((== local2 (+ deviceNum 1)) (global2 setScript: closeScript 0 deviceNum) (-- local2))
						((proc999_5 deviceNum 2 3 6 7) (global2 setScript: closeScript 0 deviceNum))
...
(instance cloakDevice of Prop
	...
	(method (doVerb theVerb)
		(switch theVerb
			(4
				(if (and (== local2 20) (not (global2 script?)))
					(global2 setScript: sRemoveDevice)
				else
