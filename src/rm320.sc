...
(instance rm320 of Rm
	...
	(method (init)
		...
		(switch gGModNum
			(305
				(= style 12)
				(global2 setScript: sUseTunnel 0 1)
			)
			(325
				(= style -32758)
			...
			(else 
				(= style -32758)
				(global2 setScript: sWD40ShipLands)
			)
		)
		(rogRock init:)
	...
	(method (doit)
		...
		(cond 
			(
			(and (proc0_5 gEgo 64) (not (global2 script?))) (global2 setScript: sUseTunnel 0 0))
			((proc0_5 gEgo 128) (global2 newRoom: 325))
			(
				(and
					(proc999_4 130 135 140 145 gEgo)
					(< 0 (gEgo heading?))
					(< (gEgo heading?) 180)
					(not (global2 script?))
				)
				(cond 
					((not (proc0_1 212)) (global2 setScript: sJumpLeftToRight))
					((not local73) (gTestMessager say: 11 0 0 0) (= local73 1))
				)
			)
			(
				(and
					(proc999_4 190 140 193 150 gEgo)
					(> (gEgo heading?) 180)
					(not (global2 script?))
				)
				(global2 setScript: sJumpRightToLeft)
			)
		)
	)
)
...
(instance sJumpLeftToRight of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(3
				(if (or (not (proc0_1 14)) (proc0_1 15))
					(= next sRockSlide)
				else
					(= next sClimbUp)
				)
