...
(instance sInTheAsteroids of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(7
				(gTestMessager say: 17 0 0 0 self 202)
			)
			(8
			...
			(11
				(gTestMessager say: 18 0 0 0 self 202)
			)
			(12
			...
			(14
				(staticSound stop:)
				(gTestMessager say: 18 0 17 1 self 202)
			)
			(15
				(staticSound loop: 1 play:)
				(= ticks 10)
			...
			(19
				(staticSound stop:)
				(gTestMessager say: 18 0 17 2 self 202)
				(= register 5)
			)
			(20 (= cycles 1))
			(21
			...
			(24
				(staticSound stop:)
				(gTestMessager say: 18 0 17 3 self 202)
			)
			(25 (= cycles 1))
			(26
				(staticSound loop: 1 play:)
			...
			(29
				(staticSound stop:)
				(gTestMessager say: 18 0 17 4 self 202)
			...
			(34
				(staticSound stop:)
				(gTestMessager say: 18 0 17 5 self 202)
			...
			(37
				(staticSound stop:)
				(gTestMessager say: 18 0 17 6 self 202)
			)
			(38 (= cycles 1))
			(39
				(staticSound loop: 1 play:)
			...
			(44
				(gTestMessager say: 18 0 59 0 self 202)
			)
			(45
		...
		(switch (= state newState)
			...
			(3
				(cond 
					...
					((and (== (eureka hits?) 2) (proc0_1 40)) (= cycles 1))
					(else
						(global2 setScript: (ScriptID 210 3) 0 12)
						(self dispose:)
					)
				)
			)
...
(instance sGoliathComments of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			(0 (proc201_6 self))
			(1
				(gTestMessager say: 13 0 13 1 self 202)
			)
			(2
				(self setScript: (ScriptID 201 4) self)
				(proc201_7)
			...
			(3
				(gTestMessager say: 13 0 6 0 self 202)
			)
			(4
				(self setScript: (ScriptID 201 8) self)
			)
